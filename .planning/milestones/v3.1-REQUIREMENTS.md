# Requirements Archive: v3.1 Sizing Correctness & Guided Workflow
...
- [x] **WIZARD-07**: Shareable URL never encodes wizard step position (ephemeral UI state excluded from lz-string payload)
